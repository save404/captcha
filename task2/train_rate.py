...
def train_crack_captcha_cnn():
	...
	learning_rate = tf.train.natural_exp_decay(initial_learning_rate, step, decay_steps=decaystep, decay_rate=decay_rate,
											   staircase=False)
	...
	for i in range(globalstep):
		...
		loss_ = sess.run(loss, feed_dict={X: batch_x, Y: batch_y, keep_prob: 0.75})
		lr = sess.run(learning_rate)
		print("step: ",i, '\t', "loss: ", loss_, "\t", "learning_rate: ", lr)
