...
class WheezyCaptcha(_Captcha):
    ...
    def __init__(self, width=200, height=80, fonts=None):
        self._width = width
        self._height = height
...
class ImageCaptcha(_Captcha):
    ...
    """
    def __init__(self, width=200, height=80, fonts=None, font_sizes=None):
        self._width = width
        self._height = height
        self._fonts = fonts or DEFAULT_FONTS
    ...
    def generate_image(self, chars):
        ...
        color = (255,0,255)#random_color(0, 200, random.randint(220, 255))
